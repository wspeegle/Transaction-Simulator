...
testRetailer:	Entity.h Entity.cpp Seller.h Seller.cpp Buyer.h Buyer.cpp Retailer.h Retailer.cpp testRetailer.cpp stockInventory.cpp createOrders.cpp Product.cpp Order.cpp Inventory.cpp
	g++ -std=c++11 -o testRetailer testRetailer.cpp Entity.cpp Seller.cpp Buyer.cpp Retailer.cpp stockInventory.cpp createOrders.cpp Product.cpp Order.cpp Inventory.cpp
...
clean:	
	rm testEntity testBuyer testSeller testRetailer simulation
